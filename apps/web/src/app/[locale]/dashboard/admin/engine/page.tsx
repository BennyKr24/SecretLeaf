    ...
    <div>
      <div className="mb-7">
        <div className="flex items-center gap-2 text-xs text-[#8fa89a]">
          <span>Admin</span><span>/</span><span className="font-semibold text-[#4d685a]">Engine</span>
        </div>
        <div className="mt-1 flex items-center gap-3">
          <span className="text-2xl">⚙️</span>
          <div>
            <h1 className="text-2xl font-bold text-[#10281e]">Engine Control</h1>
            <p className="text-sm text-[#4d685a]">Pipeline manuell steuern, adaptive Weights triggern, Logs einsehen.</p>
          </div>
        </div>
      </div>
